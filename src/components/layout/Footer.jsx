...
const Footer = () => {
  return (
    <>
      <footer class="footer p-10 mt-20 bg-base-200 text-base-content">
        <div>
      ...
      <footer class="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
        <div class="items-center grid-flow-col">
          ...
          {/* <p className="text-success-content text-2xl font-medium">
            <span className="text-accent">InstaCart</span> <br></br>The Grocery
            Run Just Got Easier
          </p> */}
          <img
